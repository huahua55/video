...
class videoVod extends Base {
    ...
    public function listData($whereOr =[],$where,$order,$page=1,$limit=20,$start=0)
    {
        ...
        if(empty($whereOr)){
            ...
            $list = Db::name('Vod')->alias('a')->field('a.vod_name,b.id as b_id,b.set_down_url as b_set_down_url,b.examine_id as b_examine_id,b.sum as b_sum,b.is_examine as b_is_examine,b.is_section as b_is_section,b.reason as b_reason,b.code as b_code,b.vod_id as b_vod_id,b.video_id as b_video_id,b.down_ts_url as b_down_ts_url,b.down_mp4_url as b_down_mp4_url,b.down_url as b_down_url,b.down_time as b_down_time,b.weight as b_weight,b.is_down as b_is_down,b.is_sync as b_is_sync')->join('video_vod b', 'a.vod_id=b.vod_id', 'right')->where($where)->order($order)->limit($limit_str)->select();
