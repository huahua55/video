...
//                p($v);
                ...
                if ($v['type_id'] == 0) {
                    ...
                    $vod_lock = $v['vod_lock'] ?? '0';
                    $v['vod_lock'] = intval($vod_lock);
                    ...
                    $v['vod_hits_day'] = intval($v['vod_hits_day'] ?? '0');
                    $v['vod_hits_week'] = intval($v['vod_hits_week'] ?? '0');
                    $v['vod_hits_month'] = intval($v['vod_hits_month'] ?? '0');
                    $v['vod_stint_play'] = intval($v['vod_stint_play'] ?? '0');
                    $v['vod_stint_down'] = intval($v['vod_stint_down'] ?? '0');
                    ...
                    $v['vod_plot_name'] = $v['vod_plot_name'] ?? '';
                    $v['vod_plot_detail'] = $v['vod_plot_detail'] ?? '';
                    ...
                    $v['vod_down_from'] = $v['vod_down_from'] ?? '';
                    $v['vod_down_server'] = $v['vod_down_server'] ?? '';
                    $v['vod_down_note'] = $v['vod_down_note'] ?? '';
                    $v['vod_down_url'] = $v['vod_down_url'] ?? '';
                    $v['vod_play_from'] = $v['vod_play_from'] ?? '';
                    $v['vod_play_url'] = $v['vod_play_url'] ?? '';
                    $v['vod_play_server'] = $v['vod_play_server'] ?? '';
                    $v['vod_play_note'] = $v['vod_play_note'] ?? '';
                            ...
                            if (count($update) > 0) {
                                ...
                                if ($get_type_pid_type_id == 1 && $is_ts_up == true) {
                                    ...
                                    if (strpos($vod_remarks, 'TC') !== false || strpos($vod_remarks, 'TS') !== false) {
                                        $new_vod_play_url = [];
                                        foreach (explode('$$$', $update['vod_play_url']) as $play_url_key => $val) {
