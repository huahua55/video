...
CREATE TABLE `vod` (
  ...
  `vod_tag` varchar(255) NOT NULL DEFAULT '' COMMENT '视频标签',
  ...
  `vod_behind` varchar(255) NOT NULL DEFAULT '' COMMENT '幕后',
  ...
  `vod_area` varchar(255) NOT NULL DEFAULT '' COMMENT '发行地区 如：大陆,香港',
  `vod_lang` varchar(255) NOT NULL DEFAULT '' COMMENT '对白语言',
  ...
  `vod_duration` varchar(30) NOT NULL DEFAULT '' COMMENT '时长',
