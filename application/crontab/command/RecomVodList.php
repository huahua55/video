...
class RecomVodList extends Common{
    ...
    protected function execute(Input $input, Output $output){
        ...
        for($i = 0; $i < $page; $i++){
            ...
            $listSql = "SELECT v.vod_id,v.vod_name as name,v.type_id_1 as type_id,v.vod_content,d.trailer_urls FROM `douban_vod_details` d JOIN vod v on d.douban_id = v.vod_douban_id LEFT JOIN recom r on r.vod_id = v.vod_id WHERE JSON_EXTRACT(trailer_urls,'$[0]') is not null AND r.id IS NULL limit " .$pageSize . "," . $limit;
